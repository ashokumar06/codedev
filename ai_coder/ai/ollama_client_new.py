"""
Enhanced Ollama API client for CodeAS - Advanced AI Coding Assistant
...
class OllamaClient:
    ...
    def _get_default_system_prompt(self) -> str:
        """Default system prompt for CodeAS"""
        return """You are CodeAS, an advanced AI coding assistant created by Ashok Kumar (https://ashokumar.in).
